...
func (_c *UserCreate) SetNillableOrganizationID(v *uuid.UUID) *UserCreate {
	if v != nil {
...
func (_c *UserCreate) AddRole(v ...*Role) *UserCreate {
...
// SetOrganizationID sets the "organization_id" field.
func (u *UserUpsert) SetOrganizationID(v uuid.UUID) *UserUpsert {
...
// SetOrganizationID sets the "organization_id" field.
func (u *UserUpsertOne) SetOrganizationID(v uuid.UUID) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
...
// SetOrganizationID sets the "organization_id" field.
func (u *UserUpsertBulk) SetOrganizationID(v uuid.UUID) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetOrganizationID(v)
	})
}
